...
6. 開発画面に戻り以下の手順で 2つの Stream でデータを取得できていることを確認します。  
...
※講師の方は、データが生成されていることを確認してください。データ生成がされていない場合は、データジェネレーターを起動し _Start Generator_ ボタンをクリックしてダミーデータの生成を開始してください。
...
6. ポンプの異常検知が正しく動作するか確認します。  
※講師の方は [ポンプの異常を発生させる方法](./0-03_DataGenerator.md#ポンプの異常を発生させる方法) を参考に異常なデータの生成を行ってください。
