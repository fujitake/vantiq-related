...
terraform {
    ...
    backend "azurerm" {
      resource_group_name  = "vantiq-tfstate-rg"
      storage_account_name = "vantiqtfstatemasanori"
...
#  pod_cidr = "172.18.0.0/16"
  ...
  mongodb_node_pool_node_count = 1
  ...
  keycloak_node_pool_node_count = 1
  metrics_node_pool_vm_size = "Standard_F4s_v2"
  metrics_node_pool_node_count = 0
}
